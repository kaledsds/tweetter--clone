  ...
  <div class="p-2 w-full">
    <div class="font-extrabold flex items-center justify-between mt-0.5 mb-1.5">
      <div class="flex items-center">
        <div>{{ tweet.name }}</div>
        <span class="font-[300] text-[15px] text-slate-500 pl-2">{{ tweet.handle }}</span>
      </div>
      <div class="rounded-full cursor-pointer  relative">
        <button type="button" class="block p-2 rounded-full hover:bg-slate-800">
