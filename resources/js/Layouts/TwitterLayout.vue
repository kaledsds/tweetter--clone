...
<template>
  <div class="fixed w-full">
    <div class="max-w-[1400px] flex mx-auto">
      ...
      <div class="lg:w-7/12 w-11/12 border-x border-slate-800 relative">
        <div class="bg-black bg-opacity-50 backdrop-blur-md z-10 absolute w-full">
          <div class="border-slate-800 border-b w-full">
      ...
      <div class="lg:block hidden lg:w-4/12 h-screen border-l border-slate-800 pl-4">
        ...
        <div class="w-full mt-4 rounded-lg lg:block hidden bg-[#212327]">
          ...
          <div class="h-[80px] hover:bg-slate-800 cursor-pointer transition duration-200 ease-in-out">
            <div class="flex p-3 justify-between h-[80px] py-3">
              <div>
                <div class="text-[14px] text-slate-400">Tennis Tournament Live</div>
                <div class="w-full text-white font-extrabold mb-6 text-[17px]">Tunisan Open 2023</div>
              </div>
              <img class="rounded-xl" :src="randImg2" alt="">
            </div>
          </div>

          <div class="hover:bg-slate-800 cursor-pointer transition duration-200 ease-in-out">
            <div class="flex p-3 justify-between">
              <div>
                <div class="text-[14px] text-slate-400">Trending in Tunisia</div>
                <div class="w-full text-white font-extrabold text-[17px]">Doomsday clock</div>
                <div class="text-[14px] text-slate-400">5,93 Tweets</div>
              </div>
          ...
          <div class="hover:bg-slate-800 cursor-pointer transition duration-200 ease-in-out">
            <div class="flex p-3 justify-between">
              <div>
                <div class="text-[14px] text-slate-400">Politics . Trending</div>
                <div class="w-full text-white font-extrabold text-[17px]">Sunak</div>
                <div class="text-[14px] text-slate-400">98,745 Tweets</div>
              </div>
              <DotsHorizontal fillColor="#5e5c5c"/>
            </div>
          </div>
          ...
          <div class="hover:bg-slate-800 cursor-pointer transition duration-200 ease-in-out">
            <div class="flex p-3 justify-between">
              <div>
                <div class="text-[14px] text-slate-400">Sports . Trending</div>
                <div class="w-full text-white font-extrabold text-[17px]">Espérance sportive de Tunis</div>
                <div class="text-[14px] text-slate-400">12,432 Tweets</div>
              </div>
              <DotsHorizontal fillColor="#5e5c5c"/>
            </div>
          </div>
  ...
  <div id="OverlaySection" v-if="createTweet" class="fixed top-0 left-0 w-full h-screen bg-black md:bg-slate-400 md:bg-opacity-30 md:p-3">
    <div class="md:max-w-2xl md:mx-auto md:mt-10 md:rounded-xl bg-black">
      <div
        ...
        "
      >
        <div @click="closeMessageBox" class="hover:bg-slate-800 inline-block p-2 rounded-full cursor-pointer">
        ...
        <button
          @click="addTweet()"
          :disabled="!tweet"
          :class="tweet ? 'bg-[#1C9CEF] text-white' : 'bg-[#124D77] text-slate-400'"
      ...
      <div class="w-full flex">
        ...
        <div class="w-[calc(100%-100px)]">
          <div class="inline-block">
            <div class="flex items-center border border-slate-700 rounded-full">
          ...
          <div class="w-full">
            <video controls v-if="uploadType === 'mp4'" :src="showUpload" class="rounded-xl max-w-[150px] max-h-[150px] overflow-auto" />
            <img v-else :src="showUpload" class="rounded-xl max-w-[150px] max-h-[150px]">
          </div>
          <div class="flex py-2 items-center text-[#1C9CEF] font-extrabold">
            <Earth class="pr-2" fillColor="#1C9CEF" :size="20"/> Everyone can replay
          </div>
          <div class="border-b-slate-700 border-b"></div>
          <div class="flex items-center justify-between py-2">
            <div class="flex items-center">
              <div class="hover:bg-slate-800 inline-block p-2 rounded-full cursor-pointer">
